  ...
  return (
    <footer className="relative w-full bg-181818 py-8" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto flex flex-col lg:flex-row justify-between lg:items-center px-6 lg:px-0 py-8 container-xl">
        <span className="text-gray-100 text-sm mb-4 lg:mb-0">&copy; {currentYear} ASPEN PUBLISHING</span>
        <div className="flex gap-4 lg:gap-8">
          <a href="https://www.facebook.com/profile.php?id=61555997104704" className="text-gray-100 text-sm">Facebook</a>
          <a href="https://www.linkedin.com/company/aspenpublishing/" className="text-gray-100 text-sm">LinkedIn</a>
          <a href="https://twitter.com/AspenPublishing" className="text-gray-100 text-sm">Twitter</a>
          <a href="https://www.youtube.com/@aspenpublishing6830" className="text-gray-100 text-sm">YouTube</a>
        </div>
      </div>
    </footer>
  );
